...
;; Hooks for modes in which to install the Sarasa ligatures
;; (mapc (lambda (hook)
;;         (add-hook hook (lambda () (setup-sarasa-ligatures) (refresh-pretty))))
;;       '(text-mode-hook prog-mode-hook))

;; (setup-sarasa-ligatures)

;; (refresh-pretty)

(global-prettify-symbols-mode +1)

(provide 'ligatures-init)
